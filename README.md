...
**Current runtime milestone: v1.12.6 attention-conditioned bank
credit review lite.** The third mechanism-level use of the v1.12.3
attention bottleneck. A new
`run_attention_conditioned_bank_credit_review_lite(...)` helper
ships alongside the existing v1.9.7 helper, routing evidence
...
`living_world_digest` remain unchanged from v1.12.4. With v1.12.6
shipped, attention is now load-bearing for **three mechanisms**:
investor intent (v1.12.4), valuation lite (v1.12.5), and bank
credit review lite (v1.12.6).
...
- [docs/test_inventory.md](japan-financial-world/docs/test_inventory.md)
  — 2602 tests grouped by component (444 v0 + 188 v1.0–v1.7 + 1970 post-v1.7)
...
Expected: `2602 passed` at the latest commit (444 v0 + 188 v1
